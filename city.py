...
class Building():
    ...
    def draw(self):
        #pygame.draw.rect(screen,self_color, (x,y), self_size)
      
      pygame.draw.rect(screen, self.color, (self.x_point, self.y_point), (self.x_point + self.width, self.y_point + self.height), 0)
...
class Scroller(object):
    ...
    def add_buildings(self):
      ...
      #add until width = number of buildings
      while self.width > 0:
        add_building()
